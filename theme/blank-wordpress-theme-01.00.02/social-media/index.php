...
function social_media_db_install() {
   global $wpdb; global $om_contact_form_db_version;
...
add_action("after_switch_theme", "social_media_db_install");
...
<div class="social-form-input-contaner"><label>Pinterest:</label><input name="pinterest" <?php echo ($social_data) ? "value=$social_data->pinterest_url" : 'placeholder="Pinterest page link"' ?>></div>
<div class="social-form-input-contaner"><label>Linkedin:</label><input name="linkedin" <?php echo ($social_data) ? "value=$social_data->linkedin_url" :'placeholder="Linkedin page link"' ?>></div>
